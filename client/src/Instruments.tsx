...
function TopNav({ name }: { name: string }) {
  return (
      <div style={{ textAlign: 'center', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '2rem', fontFamily: 'Arial, sans-serif' }}
          className={
              'animated-text w-100 h3 bb b--light-gray flex justify-between items-center ph4'
          }
    >
          {name}
    </div>
    ...
    <div>
      <TopNav name={instrument.name} />
          <div
              ...
              style={{
                  top: '4rem',
                  //backgroundImage: `url(${require('./img/homepage_bg.jpg')})`,
